# STATUT — relevé automatique « S-1811 »

Date : 2026-09-22 03:47 · État : **TERMINÉ**

## Entrées

| fichier | octets | sha256 |
|---|--:|---|
| 00 Addenda MEP-02_Plans.pdf | 6114584 | 992d728d309d3f8e856ca9f8bf909737663db8238229110b27afbd65bdcc9ae2 |
| 00 Addenda MEP01_Plans.pdf | 11827831 | 29c50725b374a95b90ab7b9d13043ca68b6927ba51efa88036ffff37b9b91678 |
| 00 Électricité_Plans_pour AO.pdf | 6532068 | fd3315554f8d8eb874e7b1dd82042758f6cb580447a75324c968bcbcc76c2f76 |

## Sorties

| fichier | octets | sha256 |
|---|--:|---|
| S-1811-Dossier-complet.pdf | 5027765 | cafb4e43699a2d29f18aa2c9c37f0676f4bc46d52af63ae833551fe01af585cf |
| S-1811-Plans-annotes.pdf | 4646996 | c3cf2def15809a559a65c8924a9954d66519e660797842fba2b06a7600100e57 |
| S-1811-Rapport-de-metre.md | 34983 | e86e930e2d5664e3ea2d159f0b28cc6c1e7bd68cc8f6d65a383c1ceb9dedab5f |
| S-1811-Rapport-de-metre.pdf | 381108 | 50020a47709deb9fff88ef89a3cedbfd75d58c3a8066a25ba8661d276735e44f |
| journal-etapes.log | 6081 | 471e282e90f42fd639dd8a5e697c70a6062ec39f852d43d63ebf6a235ed77dfa |
| S-1811-planexpert/S-1811.qpl | 100658 | 59422cb9e5c246ecb85d0698cec36139cefa30fdcccc8f4d8139d3bfcc67a5c9 |

Le projet Plan Expert `S-1811.qpl` est dans `S-1811-planexpert/` avec ses rasters PNG : copier le dossier entier, puis Fichier → Ouvrir dans Plan Expert. Le PDF « Plans annotés » et le rapport de métré ci-dessus sont rendus par `releve/render_pdf.py` à partir du même .qpl.
...
| agent Claude | 20.0 min | success / code 0 |
...
- modèle : `opus` · tours : 95 · sous-type : success
- coût estimé (client, `total_cost_usd`) : 17.378676000000002 $ US
- jetons : entrée 172, cache créé 420941, cache lu 19682512, sortie 133086
- session : `ee0971be-0747-5d2f-962e-a9f568c158d0` · dossier de travail : `/home/claude/releve-auto/runs/S-1811/OUTBOX/S-1811/travail`

### Résumé de l'agent

Le relevé de S-1811 est écrit : 811 marques et 38 réserves. **Les quantités couvrent un seul bâtiment (#1) plus le site** ; la note A du 502B demande de prévoir les 6 bâtiments (R-001).

- **Blocage :** `extract_occurrences.py`, `zoom.py` et `traits.py` n'ont pas pu s'exécuter (permission refusée). J'ai donc construit `occurrences-texte.csv` à la main à partir des fichiers de mots, et lu les symboles sur les tuiles seulement, sans zoom (R-005). **Il ne faut pas regénérer ce fichier avec le script**, sinon les libellés « urgence » et les exclusions seraient perdus.
- **Feuilles :** 36 pages classées. Les versions en vigueur sont celles de l'addenda MEP-02 pour 501B, 502B, 503B et 510B, de MEP-01 pour 505B à 508B et 511B, et de la soumission pour 504B et 509B. Les anciennes versions sont classées `remplacee`, les 13 feuilles mécaniques `autre`.
- **Marques :** 505B 272, 506B 305, 507B 12, 508B 150, site 503B 65, schéma 502B 4, tableau 511B 3. Sur 815 lignes, 4 sont exclues : un « A1 » sans appareil et trois « 500W » qui sont des serpentins. Les 79 libellés utilisés existent tous dans `nomenclature.csv`.
- **Urgence :** l'état a été lu appareil par appareil : 6 A1, 4 C1, 7 C3, 14 D1, 4 E1, plus 2 mini-onduleurs.
- **Ce qui manque :**
  - pas d'export estimateur, donc pas de `comparaison-estimateur.md` ;
  - comparaison base / addenda non faite tuile par tuile, et aucun texte d'addenda reçu ;
  - linéaires à métrer (artères, conduits, ligne aérienne) ;
  - variantes à ventiler : X1, gradateurs, prise en triangle ;
  - écarts de prises entre plan et tableaux (62 contre environ 64 dans les dortoirs, 10 contre 12 dans la classe) ;
  - statut des 8 poteaux dessinés (neufs ou existants), en plus des 5 ajoutés par la note D.

Fichiers dans `/home/claude/releve-auto/runs/S-1811/OUTBOX/S-1811/travail/` :
